...
for i=1:NUMBER_OF_TESTS
    withHeuristic = withHeuristic + ex4_run_ga(x, y, NIND, MAXGEN, NCITIES, ELITIST, STOP_PERCENTAGE, 0.95, 0.05, CROSSOVER, LOCALLOOP, LOCAL_MUT);
    withoutHeuristic = withoutHeuristic + ex4_run_without_heuristics(x, y, NIND, MAXGEN, NCITIES, ELITIST, STOP_PERCENTAGE, 0.95, 0.05, CROSSOVER, LOCALLOOP);
    disp(["TEST",i]); 
end
disp("FINAL HEURISTICS")
x = linspace(0,MAXGEN);
plot(x,withoutHeuristic/NUMBER_OF_TESTS,'--',x,withHeuristic/NUMBER_OF_TESTS)
